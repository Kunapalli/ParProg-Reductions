...
object LineOfSightRunner {
  ...
  def main(args: Array[String]) {
    ...
    println(s"speedup: ${seqtime / partime}")
     ...
     val output2 = new Array[Float](17)
     parLineOfSight(List(0f, 1f, 3f, 2f, 6f, 40f, 5f, 7f, 8f, 9f, 120f, 11f, 10f, 13f, 14f, 15f, 1600f).toArray, output2, 4)
     var i = 0
     while (i < 17) {
       println(s"output2($i) = ", output2(i))
       i = i+1
     }
...
object LineOfSight {
  ...
  def downsweep(input: Array[Float], output: Array[Float], startingAngle: Float, tree: Tree): Unit = tree match {
    case Leaf(f, u, maxp) => downsweepSequential(input, output, startingAngle, f, u)
